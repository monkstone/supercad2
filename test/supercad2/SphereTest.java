...
public class SphereTest extends PApplet {
    ...
    public void sphereTest() {  // encapsulate initial processing sketch in a function
        background(0);
        translate(width / 2, height / 2, -width / 3);
        configureLights();
        if (cadSoftware == Mode.POVRAY2) {
            g.sphere(200);
        } else {
            sphere(200);
        }
            ...
            case 't':
                if (status == Status.RECORDED) {
                    ...
                    try {
                        ...
                        Logger.getLogger(SphereTest.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
                break;
    ...
    public static void main(String[] args) {
        PApplet.main("supercad2.SphereTest");
    }
}
