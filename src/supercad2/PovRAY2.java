...
/**
 * supercad2
 * By Martin Prout, based on a original idea by Guillaume LaBelle
 * 
...
public class PovRAY2 extends Raw {
  ...
  private void writeDirtyHeader(){
    ...
    writer.println("\t\t\t\tright\t x*image_width/image_height");
    writer.println("\t\t\t\tlook_at   <0.0 , 1.0 , 0.0>}");
    writer.println("camera{default_camera}");
    writer.println("");
    writer.println("");
    writer.println("//  ------------------------------------------------------------");
    writer.println("//  ------------------------------------------------------------");
  ...
  public void declareCamera(String name, int fov, float aspectRatio){
